            ...
            <aside className="RightContainer">
                ...
                <main className="MainContainer">
                    <div className='MainTitles'>
                        ...
                        <h2 className='MainText'>Verificando dados... </h2>
                        <p className='SubText'>Estamos conferindo suas informações e <span className="ColorPurple1">número de RM no sistema</span></p>
                    </div>
